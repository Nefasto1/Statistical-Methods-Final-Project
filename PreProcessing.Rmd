...
## Linear model
### Default
Check residui, qqplot, leverage, cook's distance
...
```
## Testing without brand name

```{r warning=FALSE}
lm_model <- lm(best_price ~ os + phone_type + sellers_amount + screen_size + memory_size + battery_size + month + year + phone_type + popularity_levels, data = train)
summary(lm_model)
